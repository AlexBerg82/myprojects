...
<div id="titlo"><a class="random-title" href="view_conten.php?id='.$res_query["id_prod"].'">'.$res_query["title"].'</a></div>
<p class="random-reviews"> Rev. '.$count_reviews.'</p>
<p class="random-price"> '.group_numerals($res_query["price"]).' us. </p>
