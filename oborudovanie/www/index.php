...
window.onload = function (){
   var success = new PDFObject({ url: "./image/rele.pdf" }).embed();
};
...
<form action="index.php" method="get">
	...
	Проданы	<input type=checkbox id="2" name="prod" value="2" onClick="ChkState1();"[checked] />
	</p>
   ...
   Отдел <select id="4" required name="depart">
	...
	<p class="timeout">
	45 <input type=checkbox id="5" name="mans" value="5" onClick="ChkState2();"[checked] />
	Просроченные <input type=checkbox id="6" name="pros" value="6" onClick="ChkState2();"[checked] />
	</p>
	<p>
...
<div id="header">
	...
	<p id="add-input"><img src="./images/add-input.png" /></p>
</div>
  ...
  <tr align="center" height="50">
	<td id="hid'.$row[0].'" width="50"><p class="msto">'.$row[1].'
		<form action="index.php" method="POST">
			<a id="red-review'.$row[0].'" href=""><img src="./images/red.png" /></a>&nbsp;&nbsp;
			<a id="delete'.$row[0].'" href=""><img src="./images/del.png" /></a>
		</form></p>
	</td>
	...
	<td width="130"><p class="msto6"><div name="date_begin" id="date_begin">'.$date_format.'&nbsp;<a id="red'.$row[0].'"><img id="paint'.$row[0].'" src="./images/red.png" title="Правка даты" /></a></div>
	...
	<td width="130"><p class="msto7"><div name="date_end" id="date_end">'.$date_format2.'&nbsp;<a id="reds'.$row[0].'"><img id="paints'.$row[0].'" src="./images/red.png" title="Правка даты" /></a></div>
	...
	<td width="90"><p class="msto8"><a href="./image/'.$row[14].'" title="Просмотреть действующее сведетельство">'.$row[8].'</a><div id="zipp'.$row[0].'" data-title="Архивные документы"><img src="images/zipp.png" /></div>
';
...
<div id="zipper'.$row[0].'">';
	...
	foreach($zipp as $key => $val){
		echo '<br><a href="./image/zip/'.$val.'">'.$val.'</a>';
	}
...
echo '<div><br></p></td>
	...
	<td style="background-color:'.$color.';" width="55"><p class="msto11">'.$num_days.'</p></td>
...
$(document).ready(function(){
	$("#red'.$row[0].'").toggle(
	  function(){
		$("#red'.$row[0].'").attr("id","");
		$("#paint'.$row[0].'").attr("src","./images/reda.png");
		$("#dat'.$row[0].'").fadeIn(400);
	  },
	  function(){
		$("#red'.$row[0].'").attr("id","");
		$("#paint'.$row[0].'").attr("src","./images/red.png");
	...
	$("#reds'.$row[0].'").toggle(
	  function(){
		$("#reds'.$row[0].'").attr("id","");
		$("#paints'.$row[0].'").attr("src","./images/reda.png");
		$("#dats'.$row[0].'").fadeIn(400);
	  },
	  function(){
		$("#reds'.$row[0].'").attr("id","");
		$("#paints'.$row[0].'").attr("src","./images/red.png");
...
<style>
	...
	<div id="send-review<?=$row[0]?>">
		<p align="left" class="title-review2"> Редактирование </p>
		<p align="right" class="closs"><img src="/oborudovanie/www/images/close.png" /></p>
		<ul class="ulli2">
		...
		<p id="button-red-review<?=$row[0]?>" idd="<?=$row[0]?>"></p>
	</div>
